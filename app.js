...
const { getTopics, getArticles, patchArticleVoteById, getUsers, getCommentsByID,postCommentByArticleId, accessArticles} = require('./controler/controler');
...
app.get('/api/articles', accessArticles)
